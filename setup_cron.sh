...
echo "4) Щогодини (7-21) - рекомендовано для Smart Heartbeat"
echo "5) Власний розклад (введіть вручну)"
echo ""
read -p "Ваш вибір (1-5): " choice >&2
...
case $choice in
    ...
    4)
        ...
        DESCRIPTION="щогодини з 7:00 до 21:00 (рекомендовано)"
        ;;
    5)
