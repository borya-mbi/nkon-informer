...
- 📊 **Розумні сповіщення:** 
  ...
  - **Smart Message Editing:** Економія місця в каналі - повідомлення "Без змін" автоматично редагується (оновлюється час), а не спамить новими постами
...
| **Changes Only** | `TELEGRAM_CHAT_IDS_CHANGES_ONLY` | Нове повідомлення тільки при змінах. Якщо змін немає - **редагує** попереднє повідомлення (оновлює час), не спамить канал |

### 📸 Як це виглядає в Telegram

<table align="center"><tr>
<td align="center"><img src="assets/telegram_no_changes.jpg" height="300" alt="Без змін"><br><i>Щоденний звіт без змін</i></td>
<td align="center"><img src="assets/telegram_with_changes.jpg" height="300" alt="Зі змінами"><br><i>Звіт зі змінами</i></td>
</tr></table>
...
Коли змін не виявлено, надсилається повний перелік товарів. Кожен рядок містить: ємність (клікове посилання), Grade, назву, ціну, статус та кількість на складі `[N шт]`. Якщо залишки зменшились з моменту останнього нового повідомлення, показується кумулятивний diff `(-N)`. Для pre-order додається дата доставки. Внизу - час оновлення (🔄 = редагування існуючого повідомлення).
...
• 334Ah 🅰️➖ Grade A- | Eve LF334 Single stud | €59.20 📦Pre
  └──▷ 12-03-2026 [10908(-3) шт] 
• 314Ah 🅰️ Grade A | Eve MB31 Один штир | €59.95 📦Pre
  └──▷ 06-03-2026 [236(-1) шт]
...
Коли виявлено відмінності від попереднього запуску, надсилається **нове** повідомлення з секціями: ✨ нові товари, 💰 зміни цін (з відсотком: `🔴+31.4%` або `🟢-10.1%`), 📦 зміни статусу/дати доставки, ❌ видалені. Для кожного товару показується кількість на складі. Внизу - час (🆕 = нове повідомлення).

```
🔋 NKON LiFePO4 Monitor

✨ Нові товари (1):
• 280Ah 🅰️ Grade A | CALB L173F280A | €41.95 📦Pre
  └──▷ 18-03-2026 [500 шт]

💰 Зміни цін (1):
• 324Ah 🅰️ Grade A | REPT Battero 72174L4 €40.00 → €52.55 (🔴+31.4%) [725 шт]

📦 Зміни статусу (1):
• 📦 334Ah 🅰️➖ Grade A- | Eve LF334 Single stud
  └──▷ 01-01-2099 → 12-03-2026 | €59.20 [10911 шт]
