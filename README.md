...
Або вручну через змінні середовища чи `.env`.
...
💰 Зміни цін (2):
• [324Ah](...) 🅰️ Grade A | REPT Battero 72174L4 | €55.00 → €65.95 (🔴+19.9%)
• [280Ah](...) 🅰️ Grade A | CALB L173F280A | €60.00 → €52.95 (🟢-11.7%)

📦 Зміни статусу (1):
• ✅ [334Ah](...) 🅰️ Grade A➖ | Eve LF334 | Pre → In | €73.95
  └ 📅 12-03-2026
...
📋 Без змін (3):
• ✅In [314Ah](...) 🅰️ Grade A | Eve MB31 - €87.95
...
```
