...
- ✅ **Гнучкий парсинг ємності:** Підтримка форматів `280Ah`, `314Ah`, а також кириличного `230Аг` (для української версії сайту).
...
- ✅ **Deep Verification:** Автоматичне виявлення помилок сайту, коли товар показується "In Stock" або "Pre-order", але фактично має 0 одиниць на складі. Такі товари коректно позначаються як видалені.
